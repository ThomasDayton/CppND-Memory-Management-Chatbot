...
ChatLogic::~ChatLogic()
{
    ...
    {
      	//thanks to smart pointers, no longer need to use delete
        //delete *it;
    }
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // identify root node
    GraphNode *rootNode = nullptr; //without unique_ptr
  	//std::unique_ptr<GraphNode> rootNode (nullptr); //with unique_ptr
    for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
